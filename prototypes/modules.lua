...
for i=1,get_efficiency_tiers(),1 do
    ...
    if data.raw.module["efficiency-module"..string_concat] then 
        existing_efficiency(data.raw.module["efficiency-module"..string_concat], i)
    else
...
for i=1,get_quality_tiers(),1 do
    ...
    if data.raw.module["quality-module"..string_concat] then 
        existing_quality(data.raw.module["quality-module"..string_concat], i)
    else
        new[#new+1], new[#new+2] = new_quality(i)
    end
end
data:extend(new)